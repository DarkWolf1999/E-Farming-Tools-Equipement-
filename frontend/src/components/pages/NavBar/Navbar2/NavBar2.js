        ...
        <div>
            <nav className='navbar'>
                <div className='navbar-container'>
                    ...
                    <li className='nav-item'>
                    <Link to='/getallmodel' className='nav-links' onClick={closeMobileMenu}>Equipment Type</Link>
                    </li>
                    ...
                    <li className='nav-item'>
                    <Link to='/addmodel' className='nav-links' onClick={closeMobileMenu}>Add Equipment Type</Link>
                    </li>
